<script lang="ts">
    ...
    async function handleEdit(event: Event) {
        ...
        try {
            ...
            successMessage.className = 'fixed bottom-4 right-4 bg-green-100 text-green-800 p-4 rounded-lg shadow-lg z-50';
...
<div class="max-w-4xl mx-auto p-4 space-y-8">
    ...
    {:else if error}
        <div class="p-6 bg-red-100 dark:bg-red-900 rounded-lg {slideIn}">
