<script lang="ts">
  ...
  import { type ChatMessage, connectionState, ConnectionState, getChatMessages, type GroupChatMessage, initializeWebSocket, MessageType, resetUnreadCount, sendMessage, messages as globalMessages } from '$lib/stores/websocket'
